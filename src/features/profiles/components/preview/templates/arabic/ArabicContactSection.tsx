...
interface ArabicContactSectionProps {
  content: {
    title: string;
  };
...
export const ArabicContactSection = ({
  content,
  whatsappNumber,
  theme,
}: ArabicContactSectionProps) => {
  const handleContact = () => {
    if (whatsappNumber) {
      ...
      <div className="mx-auto flex flex-col items-center gap-6">
        <div className="flex items-center gap-4 w-[85%]">
          <div
            ...
            style={{ backgroundColor: theme.textMuted, opacity: 0.5 }}
          />
          <h3
        ...
        <div className="flex items-center gap-3" dir="ltr">
          ...
          >
            ...
            <img
              src="/images/profiles/arabic/whatsapp.svg"
              alt="WhatsApp"
