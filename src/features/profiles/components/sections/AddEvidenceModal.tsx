...
export const AddEvidenceModal: React.FC<AddEvidenceModalProps> = ({
  ...
  const handleSubmit = () => {
    ...
    onSubmit({ title: imageTitle.trim(), image: selectedImage! });
  };
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="mb-6">
          ...
          <div
            className={`w-full h-[200px] rounded-[20px] border-2 border-dashed overflow-hidden ${
              errors.image ? "border-warning-500" : "border-grey-300"
            } ${imagePreview ? "border-solid border-grey-200" : ""}`}
          >
            {imagePreview ? (
              // Image Preview
              <img
