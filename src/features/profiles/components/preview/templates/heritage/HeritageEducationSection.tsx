...
interface HeritageEducationSectionProps {
  ...
  return (
    <div className="px-4 py-6">
      ...
      <div className="space-y-2 md:space-y-7 bg-white rounded-[38px] border-2 border-[#E5E5E5]">
        <div className="w-full bg-[#602726] rounded-t-[38px] py-4">
          <div
            className="h-8.75 md:h-14.5 lg:h-16.25 bg-[url('/images/profiles/heritage/pattern-light.svg')] bg-repeat-space bg-center bg-size-[auto_35px] md:bg-size-[auto_58px] lg:bg-size-[auto_65px]"
            aria-hidden="true"
          ></div>
        </div>
