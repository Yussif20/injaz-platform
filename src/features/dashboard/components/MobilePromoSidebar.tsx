...
export const MobilePromoSidebar: React.FC = () => {
  ...
  return (
    <div className="hidden xl:flex flex-col items-center justify-start bg-shade-100 rounded-3xl pt-8 px-8 min-h-150 w-[320px]">
      {/* Title */}
      ...
      {/* Description */}
      <p className="text-primary-500 text-base mb-4">
        {createFile.promoDescription}
      </p>

      {/* App Store Buttons */}
      <div className="flex flex-col gap-3 w-full max-w-50 mb-6">
        {/* Play Store */}
        <a
          href="#"
      ...
      <div className="relative flex-1 w-full flex items-end justify-center">
        <Image
          src="/images/dashboard/create-file/smartphone-mockup.svg"
