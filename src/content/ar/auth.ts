...
export const authContent = {
  signIn: {
    ...
    phonePlaceholder: "مثال: 512345678",
  ...
  signUp: {
    ...
    passwordRequirementMinLength: "٨ أحرف على الأقل",
    passwordRequirementUpperCase: "حرف إنجليزي كبير واحد على الأقل (A-Z)",
    passwordRequirementLowerCase: "حرف إنجليزي صغير واحد على الأقل (a-z)",
    passwordRequirementNumber: "رقم واحد على الأقل (0-9)",
  ...
  errors: {
    ...
    phoneAlreadyUsed: "رقم الجوال مستخدم مسبقاً لحساب آخر",
    emailAlreadyUsed: "البريد الإلكتروني مستخدم مسبقاً لحساب آخر",
  ...
  onboarding: {
    ...
    careerJobs: {
      ...
      positionLabel: "الرتبة الوظيفية*",
      rankLabel: "الدرجة الوظيفية*",
      stageLabel: "المرحلة الدراسية*",
      startYearLabel: "سنوات العمل من*:",
      endYearLabel: "إلى*:",
